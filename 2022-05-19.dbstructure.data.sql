...
INSERT INTO "public"."countries" VALUES ('+1664', 'MS', 14, 'Montserrat', NULL, '(?:\+?1[ -]?)?664[ -]?[2-9]\d{2}[ -]?\d{4}', '(?:\+?1[ -]?)?664[ -]?[2-9]\d{2}[ -]?\d{4}', 'Only +digits or local formats allowed i.e. +1664-234-1234 or 1664 234 1234 or 664-234-1234.', 'Only +digits or local formats allowed i.e. +1664-234-1234 or 1664 234 1234 or 664-234-1234.', '+1-664-234-1234|1 664 234 1234|664 234 1234', '+1-664-234-1234|1 664 234 1234|664 234 1234', '/flags/MS.png');
INSERT INTO "public"."countries" VALUES ('+1670', 'MP', 15, 'Northern Mariana Islands', NULL, '(?:\+?1[ -]?)?670[ -]?[2-9]\d{2}[ -]?\d{4}', '(?:\+?1[ -]?)?670[ -]?[2-9]\d{2}[ -]?\d{4}', 'Only +digits or local formats allowed i.e. +1670-234-1234 or 1670 234 1234 or 670-234-1234.', 'Only +digits or local formats allowed i.e. +1670-234-1234 or 1670 234 1234 or 670-234-1234.', '+1-670-234-1234|1 670 234 1234|670 234 1234', '+1-670-234-1234|1 670 234 1234|670 234 1234', '/flags/MP.png');
INSERT INTO "public"."countries" VALUES ('+1671', 'GU', 16, 'Guam', NULL, '(?:\+?1[ -]?)?671[ -]?[2-9]\d{2}[ -]?\d{4}', '(?:\+?1[ -]?)?671[ -]?[2-9]\d{2}[ -]?\d{4}', 'Only +digits or local formats allowed i.e. +1671-234-1234 or 1671 234 1234 or 671-234-1234.', 'Only +digits or local formats allowed i.e. +1671-234-1234 or 1671 234 1234 or 671-234-1234.', '+1-671-234-1234|1 671 234 1234|671 234 1234', '+1-671-234-1234|1 671 234 1234|671 234 1234', '/flags/GU.png');
INSERT INTO "public"."countries" VALUES ('+1684', 'AS', 17, 'American Samoa', NULL, '(?:\+?1[ -]?)?684[ -]?[2-9]\d{2}[ -]?\d{4}', '(?:\+?1[ -]?)?684[ -]?[2-9]\d{2}[ -]?\d{4}', 'Only +digits or local formats allowed i.e. +1684-234-1234 or 1684 234 1234 or 684-234-1234.', 'Only +digits or local formats allowed i.e. +1684-234-1234 or 1684 234 1234 or 684-234-1234.', '+1-684-234-1234|1 684 234 1234|684 234 1234', '+1-684-234-1234|1 684 234 1234|684 234 1234', '/flags/AS.png');
...
');
INSERT INTO "public"."sessions" VALUES ('9a075a2b3a3d0a15d9b2461d1011f0de', '
AAASbG9nZ2VkaW5fZ3JvdXBuYW1l
');
INSERT INTO "public"."sessions" VALUES ('5a5965dc25adf870510ea76a4ba34053', '
...
');
INSERT INTO "public"."sessions" VALUES ('6066c112263af0046fa9d0b23ca1b0b9', '
aW5fZW1haWwKAjI1AAAAC3BhZ2VfbGVuZ3Ro
');
...
SELECT pg_catalog.setval('"public"."groups_id_seq"', 230, true);
...
SELECT pg_catalog.setval('"public"."passwd_details_id_seq"', 15, true);
...
SELECT pg_catalog.setval('"public"."passwd_id_seq"', 15, true);
...
ALTER TABLE ONLY "public"."emails"
    ADD CONSTRAINT "emails_address_fkey" FOREIGN KEY ("passwd_id") REFERENCES "public"."address"("id");
