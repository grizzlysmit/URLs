...
-- Started on 2022-07-27 20:13:26 AEST
...
SELECT pg_catalog.setval('"public"."links_id_seq"', 68, true);
...
SELECT pg_catalog.setval('"public"."links_id_seq1"', 146, true);
...
SELECT pg_catalog.setval('"public"."page_section_id_seq"', 94, true);
...
SELECT pg_catalog.setval('"public"."pages_id_seq"', 50, true);
...
-- Completed on 2022-07-27 20:13:26 AEST
