...

{
    ...
    sub new {
        ...
        $PAGES{$ident} = [
            ...
            { href => 'dummy-page0.pl', name => 'dummy page', fun => 'dummy_page0', visability => 'loggedin', }, 
    ...
    sub add_country_region_dropdowns {
        ...
        say "$indent_str                var mob                     = document.getElementById('mobile');";
        say "$indent_str                mob.setAttribute('pattern', country_regions[cr_id]['mobile_pattern']);";
        say "$indent_str                mob.setAttribute('title', country_regions[cr_id]['mobile_title']);";
        say "$indent_str                mob.setAttribute('placeholder', country_regions[cr_id]['mobile_placeholder']);";
        say "$indent_str                var lndline                 = document.getElementById('phone');";
        say "$indent_str                lndline.setAttribute('pattern', country_regions[cr_id]['landline_pattern']);";
        say "$indent_str                lndline.setAttribute('title', country_regions[cr_id]['landline_title']);";
        say "$indent_str                lndline.setAttribute('placeholder', country_regions[cr_id]['landline_placeholder']);";
        say "$indent_str            } // function country_region_onchange() //";
        say "$indent_str        </script>";
    ...
    sub profile {
        ...
        if($loggedin && $isadmin){
            ...
            for my $row (@additional_groups){
                ...
                say "                                              <input type=\"button\" id=\"btn[$cnt]\" name=\"btn[$cnt]\" value=\"$group_name\">";
                say "                                              <input type=\"hidden\" id=\"hdd[$cnt]\" name=\"group_id_add[$_group_id]\" value=\"$_group_id\">";
                #say "                                              <button type=\"button\" id=\"cross[$cnt]\" name=\"cross[$cnt]\" class=\"inner\" onclick=\"return false\" value=\"$cnt\">&otimes;</button>";
                say "                                          </td>";
                $cnt++;
            }
            say "                                      </tr>";
    ...
    sub update_countries {
        ...
        for my $region_r (@countries){
            ...
            say "                <tr class=\"exh\">";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$id</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$cc</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$prefix</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$name</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\"><img src=\"$_flag\" alt=\"$_flag\"/></div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$_cr_id</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$_region</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$_distinguishing</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$landline_pattern</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$mobile_pattern</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$landline_title</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$mobile_title</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$landline_placeholder</div></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($cnt)\"><div class=\"exh\">$mobile_placeholder</div></button>";
            say "                    </td>";
            say "                </tr>";
            if($cnt % $page_length == 0){
                say "            <tr><th>id</th><th>cc</th><th>prefix</th><th>name</th><th>flag</th><th>cr_id</th><th>region</th><th>distinguishing</th><th>landline_pattern</th><th>mobile_pattern</th><th>landline_title</th><th>mobile_title</th><th>landline_placeholder</th><th>mobile_placeholder</th></tr>";
        ...
        say "            </table>";
        say "            <script>";
        say "                function on_country_click(n){";
        say "                    var countries = {";
        $cnt = 0;
        for my $region_r (@countries){
            $cnt++;
        ...
        say "                                    };";
        say "                    var id                           = countries['' + n]['id'];";
        say "                    var cc                           = countries['' + n]['cc'];";
        say "                    var prefix                       = countries['' + n]['prefix'];";
        say "                    var _name                        = countries['' + n]['_name'];";
        say "                    var _flag                        = countries['' + n]['_flag'];";
        say "                    var cr_id                        = countries['' + n]['cr_id'];";
        say "                    var region                       = countries['' + n]['region'];";
        say "                    var distinguishing               = countries['' + n]['distinguishing'];";
        say "                    var landline_pattern             = countries['' + n]['landline_pattern'];";
        say "                    var mobile_pattern               = countries['' + n]['mobile_pattern'];";
        say "                    var landline_title               = countries['' + n]['landline_title'];";
        say "                    var mobile_title                 = countries['' + n]['mobile_title'];";
        say "                    var landline_placeholder         = countries['' + n]['landline_placeholder'];";
        say "                    var mobile_placeholder           = countries['' + n]['mobile_placeholder'];";
        ...
        say "                    var input_distinguishing         = document.getElementById('distinguishing');";
        ...
        say "                    input_distinguishing.value       = distinguishing;";
    ...
    sub chmod_page {
        ...
        $self->links('chmod_page', \%session);
        return 1;
    } ## --- end sub chmod_page


    sub chmod_pseudo_page {
        my ($self, $req, $cfg, $rec) = @_;
        my $ident           = ident $self;
        my $debug = $debug{$ident};
    ...
    sub chown_alias {
        ...
        $self->links('chown_alias', \%session);
        return 1;
    } ## --- end sub chown_alias
    ...
    sub chown_page {
        ...
        $self->links('chown_page', \%session);
        return 1;
    } ## --- end sub chown_page


    sub chown_pseudo_page {
        my ($self, $req, $cfg, $rec) = @_;
        my $ident           = ident $self;
        my $debug = $debug{$ident};
        ...
        $self->links('chown_pseudo_page', \%session);
        return 1;
    } ## --- end sub chown_pseudo_page
