...

{
    ...
    sub insert_countries {
        ...
        if($submit && $submit eq 'Insert'){
            ...
            for my $prefix (@prefixes){
                ...
                if($result && $result != 0){
                    push @msgs, "INSERT INTO countries succeeded: $name, $cc, $rprefix";
                }else{
    ...
    sub update_countries {
        ...
        if($submit && $submit eq 'Update'){
            ...
            my $mobile_title         = 'Only +digits or local formats allowed i.e. +{country-prefix}{prefix}-234-1234 or {country-prefix}{prefix} 234 1234 or {prefix}-234-1234.';
            my $landline_placeholder = '+{country-prefix}-{prefix}-234-1234|{country-prefix} {prefix} 234 1234|{prefix} 234 1234';
            my $mobile_placeholder   = '+{country-prefix}-{prefix}-234-1234|{country-prefix} {prefix} 234 1234|{prefix} 234 1234';
            ...
            #my ($self,    $cfg, $debug, $_session, $db, $fun,               $button_msg,                 $dont_do_form, @msgs) = @_;
            $self->message($cfg, $debug, \%session, $db, 'update_countries', 'Insert some more countries', 1,        @msgs) if @msgs;
            #return $return;
        }else{
            @Countries = @countries;
        }
        ...
        say "                    </td>";
        say "                    <tdo colspan=\"2\">";
        say "                        <input  name=\"id\" id=\"id\" value=\"\" readonly=\"readonly\"/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input name=\"prefix\" id=\"prefix\" value=\"\"/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input name=\"name\" id=\"name\" value=\"\"/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        say "                        <label for=\"_flag\"><img id=\"the_flag\" src=\"/flags/AU.png\" alt=\"nothing yet\"/></label>";
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input name=\"_flag\" id=\"_flag\" value=\"\"/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input name=\"landline_pattern\" id=\"landline_pattern\" value=\"\"/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input name=\"mobile_pattern\" id=\"mobile_pattern\" value=\"\"/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input name=\"landline_title\" id=\"landline_title\" value=\"\"/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input name=\"mobile_title\" id=\"mobile_title\" value=\"\"/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input name=\"landline_placeholder\" id=\"landline_placeholder\" value=\"\"/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input name=\"mobile_placeholder\" id=\"mobile_placeholder\" value=\"\"/>";
        say "                    </td>";
        say "                </tr>";
        ...
        for my $region (@countries){
            ...
            say "                <tr>";
            say "                    <td>";
            say "                        <button type=\"submit\" onclick=\"on_country_click($id)\">$id</button>";
            say "                    </td>";
            say "                    <td>";
            say "                        <button type=\"submit\" onclick=\"on_country_click($id)\">$cc</button>";
            say "                    </td>";
            say "                    <td>";
            say "                        <button type=\"submit\" onclick=\"on_country_click($id)\">$prefix</button>";
            say "                    </td>";
            say "                    <td>";
            say "                        <button type=\"submit\" onclick=\"on_country_click($id)\">$name</button>";
            say "                    </td>";
            say "                    <td>";
            say "                        <img src=\"<button type=\"submit\" onclick=\"on_country_click($id)\">$_flag</button>\" alt=\"<button type=\"submit\" onclick=\"on_country_click($id)\">$_flag</button>\"/>";
            say "                    </td>";
            say "                    <td>";
            say "                        <button type=\"submit\" onclick=\"on_country_click($id)\">$landline_pattern</button>";
            say "                    </td>";
            say "                    <td>";
            say "                        <button type=\"submit\" onclick=\"on_country_click($id)\">$mobile_pattern</button>";
            say "                    </td>";
            say "                    <td>";
            say "                        <button type=\"submit\" onclick=\"on_country_click($id)\">$landline_title</button>";
            say "                    </td>";
            say "                    <td>";
            say "                        <button type=\"submit\" onclick=\"on_country_click($id)\">$mobile_title</button>";
            say "                    </td>";
            say "                    <td>";
            say "                        <button type=\"submit\" onclick=\"on_country_click($id)\">$landline_placeholder</button>";
            say "                    </td>";
            say "                    <td>";
            say "                        <button type=\"submit\" onclick=\"on_country_click($id)\">$mobile_placeholder</button>";
            say "                    </td>";
            say "                </tr>";
            if($cnt % $page_length == 0){
                say "            <tr><th>id</th><th>cc</th><th>prefix</th><th>name</th><th>flag</th><th>landline_pattern</th><th>mobile_pattern</th><th>landline_title</th><th>mobile_title</th><th>landline_placeholder</th><th>mobile_placeholder</th></tr>";
        ...
        say "                    input_the_flag.src               = _flag;";
        say "                    input_the_flag.alt               = _flag;";
