...

{
    ...
    sub register {
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input type=\"password\" name=\"password\" id=\"password\" placeholder=\"password\" minlength=\"10\" pattern=\"(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*(?:[`~\@#\\\$\%^&*()_-.]|\\[|\\]\{\\})).{10,100}\" title=\"Must supply between 10 and 100 character's the more the better.\" required/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input type=\"password\" name=\"repeat\" id=\"repeat\" placeholder=\"repeat password\" minlength=\"10\" pattern=\"(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*(?:[`~\@#\\\$\%^&*()_-.]|\\[|\\]\{\\})).{10,100}\" title=\"Must supply between 10 and 100 character's the more the better.\"  required/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
