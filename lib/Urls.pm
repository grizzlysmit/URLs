...

{
    ...
    sub user {
        ...
        say "                    </td>";
        say "                </tr>";
        say "                <tr><th>id</th><th>username</th><th>given names</th><th>family name</th><th>email</th><th>mobile</th><th>land line</th><th>group</th><th>admin</th><th>additional_groups</th><th>selected</th><th>Edit Button</th></tr>";
        my $cnt = 0;
        for my $user (@user_details){
            ...
            say "                </tr>";
            if($cnt % $page_length == 0){
                say "                <tr><th>id</th><th>username</th><th>given names</th><th>family name</th><th>email</th><th>mobiler</th><th>land line</th><th>group</th><th>admin</th><th>additional_groups</th><th>selected</th><th>Edit Button</th></tr>";
            }
        }
        say "                <tr>";
        say "                    <td>";
    ...
    sub user_details {
        ...
        say "                            }";
        say "                            ";
        say "                            \$(\".dropdown td img.flag\").addClass(\"flagvisibility\");";
        say "                            ";
        say "                            \$(\".dropdown td dt a\").click(function() {";
        say "                                \$(\".dropdown td dd ul\").toggle();";
        say "                            });";
        say "                            ";
        ...
        say "                                var countries_id = getSelectedValue(\"cc_prefix\");";
        say "                                \$(\"#cc_id\").val(countries_id);";
        say "                                var cc_flag = document.getElementById('cc_flag');";
        say "                                countries_onchange(countries_id)";
        say "                            });";
        say "                            ";
        say "                            function getSelectedFlag(id) {";
        say "                                return \$(\"#\" + id).find(\"dt a img.flag\").getAttribute('src');";
        say "                            }";
        say "                            ";
        say "                            function getSelectedValue(id) {";
        say "                                return \$(\"#\" + id).find(\"dt a span.value\").html();";
        say "                            }";
        say "                            ";
        say "                            \$(document).bind('click', function(e) {";
        say "                                var \$clicked = \$(e.target);";
        say "                                if (! \$clicked.parents().hasClass(\"dropdown\"))";
        say "                                    \$(\".dropdown td dd ul\").hide();";
        say "                            });";
        say "                            ";
        say "                            \$(\".dropdown td img.flag\").toggleClass(\"flagvisibility\");";
        say "                            ";
        say "                            //\$(\"#cc_id\").val($countries_id);";
        say "                            ";
        #say "                            col = document.getElementsByClassName('cc_id')";
        #say "                            for(elt of col){";
        #say "                                if(elt.find('dt a span.value').html() == $countries_id){";
        #say "                                    var text = elt.find('dt a span.value').html();";
        #say "                                    \$(\".dropdown dt a span\").html(text);";
        #say "                                    ";
        #say "                                }";
        #say "                            }";
