...

{
    ...
    sub register {
        ...
        say "                    </td>";
        say "                    <td>";
        say "                        <input type=\"email\" name=\"email\" id=\"email\" placeholder=\"fred\@flintstone.com\" pattern=\"[a-z0-9]+\@[a-z0-9]+(?:\.[a-z0-9]+)+\" title=\"only a-z and 0-9 allowed (no uppercase)\" required/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td>";
        say "                        <input type=\"password\" name=\"password\" id=\"password\" placeholder=\"password\" minlength=\"10\" pattern=\".{10,100}\" title=\"Must supply between 10 and 100 character's the more thee better.\" required/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td>";
        say "                        <input type=\"password\" name=\"repeat\" id=\"repeat\" placeholder=\"repeat password\" minlength=\"10\" pattern=\".{10,100}\" title=\"Must supply between 10 and 100 character's the more thee better.\"  required/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
