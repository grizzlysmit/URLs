...

{
    ...
    sub register {
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input type=\"text\" name=\"postal_unit\" id=\"postal_unit\" placeholder=\"unit number\" pattern=\"$pattern\" title=\"$title\" hidden />";
        say "                    </td>";
        say "                </tr>";
        $title   = "\`;\`, \`'\` and \`&quot;\` not allowed";
        $pattern = "[^;'\\x22]+";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input type=\"text\" name=\"postal_street\" id=\"postal_street\" placeholder=\"street\" pattern=\"$pattern\" title=\"$title\" required/>";
        say "                    </td>";
        say "                </tr>";
        $title   = "\`;\`, \`'\` and \`&quot;\` not allowed";
        $pattern = "[^;'\\x22]+";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input type=\"text\" name=\"postal_city_suberb\" id=\"postal_city_suberb\" placeholder=\"city/suberb\" pattern=\"$pattern\" title=\"$title\" required/>";
        say "                    </td>";
        say "                </tr>";
        $title   = "\`;\`, \`'\` and \`&quot;\` not allowed";
        $pattern = "[^;'\\x22]+";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input type=\"text\" name=\"postal_postcode\" id=\"postal_postcode\" placeholder=\"postcode\" pattern=\"$pattern\" title=\"$title\" required/>";
        say "                    </td>";
        say "                </tr>";
        $title   = "\`;\`, \`'\` and \`&quot;\` not allowed";
        $pattern = "[^;'\\x22]+";
