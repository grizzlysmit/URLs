...

{
    ...
    sub update_countries {
        ...
        for my $region (@countries){
            ...
            say "                <tr class=\"exh\">";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($id)\">$id</button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($id)\">$cc</button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($id)\">$prefix</button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($id)\">$name</button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($id)\"><img src=\"$_flag\" alt=\"$_flag\"/></button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($id)\">$landline_pattern</button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($id)\">$mobile_pattern</button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($id)\">$landline_title</button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($id)\">$mobile_title</button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($id)\">$landline_placeholder</button>";
            say "                    </td>";
            say "                    <td class=\"exh\">";
            say "                        <button type=\"button\" class=\"ex exh\" onclick=\"on_country_click($id)\">$mobile_placeholder</button>";
            say "                    </td>";
            say "                </tr>";
            if($cnt % $page_length == 0){
                say "            <tr><th>id</th><th>cc</th><th>prefix</th><th>name</th><th>flag</th><th>landline_pattern</th><th>mobile_pattern</th><th>landline_title</th><th>mobile_title</th><th>landline_placeholder</th><th>mobile_placeholder</th></tr>";
