...

{
    ...
    sub register {
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input type=\"text\" name=\"username\" id=\"username\" placeholder=\"username\" pattern=\"[a-zA-Z0-9_]+\" title=\"only a-z, A-Z, 0-9 and _  allowed\" required/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input type=\"email\" name=\"email\" id=\"email\" placeholder=\"fred\@flintstone.com\" pattern=\"[a-z0-9.+-_]+\@[a-z0-9-]+(?:\.[a-z0-9-]+)+\" title=\"only a-z 0-9 '.', '+', '-', and '_' followed by \@ a-z, 0-9 '.' and '-' allowed (no uppercase)\" required/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input type=\"password\" name=\"password\" id=\"password\" placeholder=\"password\" minlength=\"10\" pattern=\"(?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9]).{10,100}\" title=\"Must supply between 10 and 100 character's the more the better.\" required/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
        ...
        say "                    </td>";
        say "                    <td colspan=\"2\">";
        say "                        <input type=\"password\" name=\"repeat\" id=\"repeat\" placeholder=\"repeat password\" minlength=\"10\" pattern=\"(?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9]).{10,100}\" title=\"Must supply between 10 and 100 character's the more the better.\"  required/>";
        say "                    </td>";
        say "                </tr>";
        say "                <tr>";
        say "                    <td>";
