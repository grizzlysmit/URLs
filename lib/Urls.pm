...

{
    ...
    sub insert_countries {
        ...
        $landline_title       = 'Only +digits or local formats allowed i.e. +{country-prefix}{distinguishing}-956-2876 or (0{distinguishing}) 756 2876 or 0{distinguishing}7562876.' unless defined $landline_title;
